/* Copyright 2010-2013 JP Norair
  ...
  */
/**
  * @file       /platform/stm32f0xx/core_isr.c
  * @author     JP Norair
  * @version    R100
  * @date       16 Jan 2013
  * @brief      OpenTag Platform ISRs for STM32F0 devices
  * @ingroup    Platform
  *
  *
  ******************************************************************************
...
#include <otstd.h>
#include <app/isr_config_STM32F0.h>      // Must be in your app distribution!
...
/// RTC Alarm interrupt is not used presently in STM32F0, but if the RTC is used
/// as a system timer the way it is on STM32L1, then this becomes important
