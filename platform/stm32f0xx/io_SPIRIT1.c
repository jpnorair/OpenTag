/* Copyright 2014 JP Norair
  ...
  */
/**
  * @file       /platform/stm32f0xx/io_SPIRIT1.c
  * @author     JP Norair
  * @version    R100
  * @date       4 Sep 2014
  * @brief      SPIRIT1 transceiver interface implementation for STM32F0xx
  * @ingroup    SPIRIT1
  *
  ******************************************************************************
  */
...
/// On STM32F0, the peripheral clock must be enabled for the peripheral to work.
