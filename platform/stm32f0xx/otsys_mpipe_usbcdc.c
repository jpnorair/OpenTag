...
#if (defined(__STM32F0__) && OT_FEATURE(MPIPE) && (BOARD_PARAM_MPIPE_IFS == 1) && defined(MPIPE_USB))
...
///@note this function is universal across all STM32 USB devices
void Resume(RESUME_STATE eResumeSetVal) {
    ot_u16 wCNTR;
...
void Get_SerialNum(void) {
    ///@todo fix addresses of Device ID
