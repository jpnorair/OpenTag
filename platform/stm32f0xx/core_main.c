/* Copyright 2014 JP Norair
  ...
  */
/**
  * @file       /otplatform/stm32f0xx/core_main.c
  * @author     JP Norair
  * @version    R100
  * @date       27 Aug 2014
  * @brief      Main, core platform implementation for STM32F0
  * @ingroup    Platform
  *
  ******************************************************************************
  */
...
void platform_init_OT() {
    ...
    /// 2. Initialize time system.  If not enabled, don't worry, this does nothing
    time_init_utc(364489200);
