/* Copyright 2014 JP Norair
  ...
  */
/**
  * @file       /platform/cc13xx/otlib_eax.c
  * @author     JP Norair
  * @version    R100
  * @date       21 Aug 2014
  ...
  * @ingroup    EAX Driver
  *
  * EAX requires AES-CTR as a foundation.  The CC13xx includes an AES 
  * coprocessor that is compatible with AES-CTR, therefore these hardware 
  * enabled routines will supplant the software-based OTlib defaults.
  * 
  ******************************************************************************
  */
