...
/**
  ...
  * @version    V1.0
  * @date       16 April 2012
  * @brief      Application Configuration File for PaLFi Demo
  *
...
#define OT_FEATURE_M2NP_CALLBACKS       ENABLED                             // Dynamic callbacks from Network (M2NP) layer
#define OT_FEATURE_M2QP_CALLBACKS       ENABLED                             // Dynamic callbacks from Transport (M2QP) layer
...
#define ISF_ENMIRROR_iss_list                  0
