/* Copyright 2010-2012 JP Norair
  ...
  */
/**
  * @file       /apps/demo_sniffer/code/app_config.h
  * @author     JP Norair (jpnorair@indigresso.com)
  * @version    V1.0
  * @date       31 July 2012
  * @brief      Application Configuration File for Sniffer Demo
  *
