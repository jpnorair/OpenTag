/* Copyright 2012 JP Norair
  ...
  */
/**
  * @file       /apps/demo_sniffer/code/default_data.c
  * @author     JP Norair
  * @version    V1.0
  * @date       31 July 2012
  * @brief      Sniffer Demo Default Data
  * 
  ******************************************************************************
  */
...
const ot_u8 isf_stock_files[] = {
    ...
    __VID,                                              /* VID */
    0xF0,                                               /* Device Subnet (universal) */
    0x11,                                               /* Beacon Subnet (N/A)*/
    ...
    0x07, 0x50, 0x00, 0x00,                             /* Channel X scan, Scan Code, Next Scan ms */
    0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF,
