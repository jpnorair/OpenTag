/* Copyright 2012 JP Norair
  ...
  */
/**
  * @file       /apps/demo_bgwakeup/code/default_data.c
  * @author     JP Norair
  * @version    R100
  * @date       31 July 2012
  * @brief      BG Wakeup Demo Default Data
  * 
  ******************************************************************************
  */
...
const ot_u8 isf_stock_files[] = {
    ...
    0x7F, 0x30, 0x00, 0x80,                             /* Channel X scan, Scan Code, Next Scan ms */
    0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF,
    ...
    /* Period data format in Section X.9.4.5 of Mode 2 spec */
    0x07, 0x80, 0x04, 0x00,                             /* Channel X scan, Scan Code, Next Scan ms */
    ...
    0x2A, 0x06, 0x20, 0x00, 0x00, 0x08, 0x40, 0x00,
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    ...
    /* User ID: id=0x11, len=24, alloc=60 */
    'A','P','P','=','B','G','W','a','k','e','u','p',
    ' ','A','P','P','=','P','o','n','g','L','T',' ',
    0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
