/* Copyright 2010-2011 JP Norair
  ...
  */
/**
  * @file       /OTplatform/~MCU_MSP430/MSP430F5/msp430f5_pmm.h
  * @author     JP Norair
  * @version    V1.0
  * @date       15 Nov 2011
...
#ifndef __MSP430F5_LIB_PMM
#define __MSP430F5_LIB_PMM
...
/** @brief Sets the Core Voltage to a specified level
  ...
  *
  * The MSP430F5 documentation shows that levels 0, 1, 2, 3, correspond to core
...
/** @brief Sets up the MSP430F5 for LPM0
  * @param None
  * @retval None
  * @ingroup MSP430F5_lib
  */
...
/** @brief Sets up the MSP430F5 for LPM1
  * @param None
  * @retval None
  * @ingroup MSP430F5_lib
  */
...
/** @brief Sets up the MSP430F5 for LPM2
  * @param None
  * @retval None
  * @ingroup MSP430F5_lib
  */
...
/** @brief Sets up MSP430F5 for LPM3, using LFXT1 to drive the ACLK
  ...
  * Note:           ACLK = LFXT1 = 32kHz, MCLK = SMCLK = default DCO
  *
  */
...
/** @brief Sets up the MSP430F5 for LPM4
  * @param None
  * @retval None
  * @ingroup MSP430F5_lib
  */
