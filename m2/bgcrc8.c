...
/**
  ...
  * @version    R100
  * @date       19 Nov 2016
  * @brief      CRC-8 (Baicheva polynomial)
  * @ingroup    Encode
  *
  * LoRa PHY uses a CRC-8 on the background frames, in order to keep them 
  * aligned to the symbol width and interleaver (makes a big difference)
  *
  ******************************************************************************
  */
