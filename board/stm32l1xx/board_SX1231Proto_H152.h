/*  Copyright 2010-2011, JP Norair
  ...
  */
/**
  * @file       /board/STM32L1xx/board_SX1231Proto_H152.h
  * @author     
  * @version    V1.0
  * @date       17 November 2011
  * @brief      Olimex STM32H152 + SX1231 module prototype setup
  * @ingroup    Board
  *
...
#ifndef __board_SX1231Proto_H152_H
#define __board_SX1231Proto_H152_H

#include "build_config.h"
#include "platform_STM32L1xx.h"
#include "radio_SX1231.h"
...
/** Supported [Known] Platforms (Boilerplate STM32 Board Config) <BR>
  * ========================================================================<BR>
...
#elif defined (STM32L15X_MD) || defined(_STM32L152VBT6_)
...
#define MCU_FEATURE_MPIPEVCOM           DISABLED
...
#define OT_GPTIM_INDEX      9                           // GPTIM INDEX: TIMx, 0 for using Systick, or -1 for RTC
#define OT_GPTIM            TIM9
#define OT_GPTIM_IRQn       TIM9_IRQn
...
#   define RXTIM             TIM10
#   define RXTIM_IRQn        TIM10_IRQn

#   define APPTIM             TIM11
#   define APPTIM_IRQn        TIM11_IRQn
...
/** Peripheral definitions for this platform <BR>
  ...
  * SX1231 has maximum 10 MHz SPI Clock.  SPI has a minimum clock divider of 2, 
...
#define GPIO_Pin_PLL_LOCK      GPIO_Pin_3
//SX1212 #define GPIO_Pin_RFIRQ0        GPIO_Pin_4
//SX1212 #define GPIO_Pin_RFIRQ1        GPIO_Pin_5
#define GPIO_Pin_RxReady       GPIO_Pin_6   // SX1231-DIO4
#define GPIO_Pin_PacketSent    GPIO_Pin_4   // SX1231-DIO0
#define GPIO_Pin_FifoLevel     GPIO_Pin_5   // SX1231-DIO1

#define GPIO_Port_RxReady      GPIOA
#define GPIO_Port_PacketSent   GPIOA
#define GPIO_Port_FifoLevel    GPIOA

#define GPIO_Pin_LED_RED        GPIO_Pin_10 // STAT1
#define GPIO_Pin_LED_GREEN      GPIO_Pin_11 // STAT2
#define GPIO_Port_LED_RED       GPIOE
#define GPIO_Port_LED_GREEN     GPIOE
#define RED_LED_OFF         GPIO_WriteBit(GPIO_Port_LED_RED, GPIO_Pin_LED_RED, Bit_SET)
#define RED_LED_ON          GPIO_WriteBit(GPIO_Port_LED_RED, GPIO_Pin_LED_RED, Bit_RESET)
#define GREEN_LED_OFF       GPIO_WriteBit(GPIO_Port_LED_GREEN, GPIO_Pin_LED_GREEN, Bit_SET)
#define GREEN_LED_ON        GPIO_WriteBit(GPIO_Port_LED_GREEN, GPIO_Pin_LED_GREEN, Bit_RESET)

#define GPIO_Pin_CON2_40         GPIO_Pin_9
#define GPIO_Port_CON2_40        GPIOC

#define GPIO_Port_RFIRQ        GPIOA
#define GPIO_Port_PLL_LOCK    GPIOA

#define GPIO_Pin_NSS_DATA  GPIO_Pin_9    // A
#define GPIO_Port_NSS_DATA  GPIOA

#define GPIO_Pin_NSS_CONFIG  GPIO_Pin_12    // B
#define GPIO_Port_NSS_CONFIG  GPIOB

#define ASSERT_NSS_CONFIG()        GPIO_ResetBits(GPIO_Port_NSS_CONFIG, GPIO_Pin_NSS_CONFIG)
#define DEASSERT_NSS_CONFIG()        GPIO_SetBits(GPIO_Port_NSS_CONFIG, GPIO_Pin_NSS_CONFIG)

#define ASSERT_NSS_DATA()        GPIO_ResetBits(GPIO_Port_NSS_DATA, GPIO_Pin_NSS_DATA)
#define DEASSERT_NSS_DATA()        GPIO_SetBits(GPIO_Port_NSS_DATA, GPIO_Pin_NSS_DATA)
