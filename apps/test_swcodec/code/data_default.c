...
const ot_u8 overhead_files[] = {
    ...
    SPLIT_SHORT_LE(ISF_BASE(network_settings)),		/* File-data virtual address in VWORM */
    SPLIT_SHORT_LE(ISF_MIRROR(network_settings)),   /* File-data virtual address in VSRAM */
...
const ot_u8 isf_stock_files[] = {
    ...
    M2_PARAM(MFPP),                                     /* Max Frames per Packet */
    ...
    /* Period data format in Section X.9.4.5 of Mode 2 spec */
    0x97, 0x0F, 0x04, 0x00,                             /* Channel X scan, Scan Code, Next Scan ticks */
    0x97, 0x0F, 0x04, 0x00,
    0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF,
    ...
    0x97, 0x07, 0x30, 0x18, 0x00, 0x00, 0x04, 0x00,     /* Chan 17, Option 07, loc. series, next in 1024 ticks */
