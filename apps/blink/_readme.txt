Blink
=====
Just a test project that blinks LEDs via a kernel task.  It is intended for the purpose of testing the platform code and scheduler related to core RTOS features.
