...
#elif (defined(BOARD_HayTag_LoRa_GPS))
#   include <app/isr_config_STM32L0.h>
#   include <board/stm32l0xx/board_HayTag_LoRa-GPS.h>

#elif defined(BOARD_HayTag_LoRa_R2_GPS)
#   include <app/isr_config_STM32L0.h>
#   include <board/stm32l0xx/board_HayTag_LoRa_R2-GPS.h>
