...
// Selector to apply default Chip, in case not defined
#if (   !defined(STM32F030) \
     && !defined(STM32F031) \
     && !defined(STM32F051) \
     && !defined(STM32F072) \
     && !defined(STM32F042) )
#   warning "No STM32F0XX family defined, defaulting to STM32F072"
//#   define STM32F030 
//#   define STM32F031
//#   define STM32F042
//#   define STM32F051 
...
///@note [JPN] Old Legacy definitions.  These are problematic and commented-out
/*
...
///@note [JPN] For most of these parameters, OpenTag uses its own set of 
///     constants that are defined in the platform/config.h file or in the 
///     board support header.  I have removed the excessive comments from ST
///     here, because this section is both self-explanatory and unnecessary.
#if !defined  (HSE_VALUE)     
#   define HSE_VALUE            ((uint32_t)8000000) /*!< Hz of the External oscillator */
#endif
...
#   define HSI_VALUE            ((uint32_t)8000000) /*!< Target Hz of the Internal High Speed oscillator */
#endif 
#if !defined  (HSI14_VALUE) 
#   define HSI14_VALUE          ((uint32_t)14000000) /*!< Target Hz of Internal High Speed oscillator for ADC */
#endif
#if !defined  (HSI48_VALUE) 
#   define HSI48_VALUE          ((uint32_t)48000000) /*!< Target Hz of Internal High Speed oscillator for USB */
#endif 
#if !defined  (LSI_VALUE) 
#   define LSI_VALUE            ((uint32_t)40000)    /*!< Target Hz of the Internal Low Speed oscillator */
#endif
#if !defined  (LSE_VALUE) 
#   define LSE_VALUE            ((uint32_t)32768)    /*!< Hz of the External Low Speed oscillator */
#endif
