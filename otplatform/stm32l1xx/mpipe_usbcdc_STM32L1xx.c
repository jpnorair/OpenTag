/* Copyright 2010-2013 JP Norair
  ...
  */
/**
  * @file       /otplatform/stm32l1xx/mpipe_usbcdc_STM32L.c
  * @author     JP Norair
  * @version    R101
  * @date       14 Nov 2013
...
void sub_gen_mpipecrc() {
    cdcacm.header.crc16 = platform_crc_block_manual((ot_u8*)&cdcacm.header.plen, 
                                                    4, 
                                                    0xFFFF  );
                                                    
    cdcacm.header.crc16 = platform_crc_block_manual((ot_u8*)mpipe.alp.outq->getcursor, 
                                                    cdcacm.header.plen, 
                                                    cdcacm.header.crc16 );
    ...
    switch (mpipe.state) {
        ...
        case MPIPE_RxPayload: 
            if (cdcacm.pkt == cdcacm.pktend) {
                if (platform_crc_block_manual(cdcacm.pkt, cdcacm.header.plen, cdcacm.header.crc16) == 0) {
