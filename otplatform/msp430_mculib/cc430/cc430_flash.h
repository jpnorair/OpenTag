/* Copyright 2009 JP Norair
  ...
  *
  */
/** @file       /Platforms/CC430/cc430_lib/cc430_flash.h
  * @author     JP Norair
  * @version    V1.0
  * @date       15 Nov 2011
  ...
  * writes, per Errata FLASH31 of the CC430 Errata list.  Errata FLASH29 and
...
// FLASH Segment Addresses (For CC430 with 32 KB Flash)
...
/** @brief Writes a single byte to an address in Flash, from code running in Flash
  ...
  * @ingroup CC430_lib
  *
  * CC430 Flash can be written to four times before it must be erased and 
