...
#define OT_FEATURE_TIME                  ENABLED
...
/** ISSB Files (Indexed Short File Series Block)
  * ISSB Files are strings of ISFB File IDs that are used
...
#define ISS_TOTAL_BYTES                     160
#define ISS_START_VADDR                     0x0360
