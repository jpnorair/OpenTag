/* Copyright 2014 JP Norair
  ...
  */
/**
  * @file       /platform/stm32l0xx/io_SPIRIT1.c
  * @author     JP Norair
  * @version    R100
  * @date       21 Sept 2014
  * @brief      SPIRIT1 transceiver interface implementation for STM32L0xx
  * @ingroup    SPIRIT1
  *
  ******************************************************************************
  */
...
#if (OT_FEATURE(M2) && defined(__SPIRIT1__) && defined(__STM32L4__))
...
#   define _RFIRQ2  (EXTI0_1_IRQn)
#   undef _EXTI0_1_USED
#   define _EXTI0_1_USED
#elif (RADIO_IRQ2_SRCLINE < 4)
#   define _RFIRQ2  (EXTI2_3_IRQn)
#   undef _EXTI2_3_USED
#   define _EXTI2_3_USED
#else
#   define _RFIRQ2  (EXTI4_15_IRQn)
#   undef _EXTI4_15_USED
#   define _EXTI4_15_USED
#endif
