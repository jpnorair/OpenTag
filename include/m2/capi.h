...
/** @brief "Calls" ISF or ISF series and writes the return data to the TX ot_queue 
  * @param  status      (ot_u8*) returns a status code (0 = error)
...
/** @brief  Writes the request datastream command, including read directives
  * @param  status      (ot_u8*) returns a status code (0 = error)
  * @param  dsq         (ot_queue*) ot_queue where the request datastream is stored
  * @retval ot_u16      post-op length of the TX queue
  * 
  *
  * API dir_cmd == 0x09
...
/** @brief  Writes the propose datastream command, including optional write directives
  * @param  status      (ot_u8*) returns a status code (0 = error)
  * @param  dsq         (ot_queue*) ot_queue where the propose [write] datastream is stored
  * @retval ot_u16      post-op length of the TX queue
  * 
  *
  * API dir_cmd == 0x0A
