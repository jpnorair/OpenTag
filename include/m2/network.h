...
/** @brief  Appends to the TX ot_queue the Device ID of this Device
...
/** @brief  Compares void input string to this Device's ID
  ...
  * @ingroup Network
  *
  * In typical usage, the "id" parameter comes from the RX ot_queue, applied as
...
/** @brief  Prepares an M2AdvP flood from a session container
  ...
  * in order to begin an M2AdvP flood process.  It reconfigures the TX ot_queue
...
/** @brief  Reverts the data framing from flood to normal mode
  ...
  *
  * This function is typically called by the Data Link Layer / System module
  * in order to end an M2AdvP flood process.  It reconfigures the TX ot_queue
