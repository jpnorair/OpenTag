...
/**
  ...
  * @version    R100
  * @date       29 Sept 2014
  * @brief      Board Configuration for Charon R0 board
  * @ingroup    Platform
  *
  * "Charon" is a tiny, USB-device dev kit.
  * - R0 uses STM32L052K8
  * - There is no RF connectivity, just USB, UART, SPI, I2C, and a control pin.
  * @todo link to wiki
  * 
...
#   if defined(__USE_SPI)
    GPIOB->AFR[0]   = (5 << ((BOARD_SPI_MOSIPINNUM)*4)) \
...
/** EXTI Line Utilization declaration <BR>
  * ========================================================================<BR>
  * On this module, no EXTIs are used
  */
//#ifndef __USE_EXTI0
//#   define __USE_EXTI0
//#endif
