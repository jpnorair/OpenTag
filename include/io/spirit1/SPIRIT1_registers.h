/* Copyright 2013-2014 JP Norair
  ...
  */
/**
  * @file       /include/io/spirit1/SPIRIT1_registers.h
  * @author     JP Norair
  * @version    R101
  * @date       4 Feb 2014
...
// Using 108.48 kHz x 16 channel setup (old draft)
...
// Using 116 kHz x 15 channel setup (new)
// Only 48 MHz XTAL implemented so far
// | XO | Fbase            | SYNT (dec)    | SYNT (hex)
// +----+------------------+---------------+----------------
// | 48 | 433109941.40625  | 14192146.56   | 0x00D88E12

#define _SYNT_D7_24MHz          0x01B12945
#define _SYNT_D7_25MHz          0x019FD5CE
#define _SYNT_D7_26MHz          0x018FD6D2
#define _SYNT_D7_48MHz          0x00D88E12  //0x00D894A2 
...
#   define _CHSPACE_D7_48MHz    79  //(79 = 116kHz channel, 74 = 108.48kHz channel)
#   define _CHSPACE_D7_50MHz    76
#   define _CHSPACE_D7_52MHz    73   
