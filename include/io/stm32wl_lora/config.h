/* Copyright 2009-2014 JP Norair
  ...
  */
/**
  * @file       /io/stm32wl_lora/config.h
  * @author     JP Norair
  * @version    R101
  * @date       27 Jan 2022
  * @brief      Radio configuration file for STM32WL LoRa
  * @ingroup    Platform
  *
...
#ifndef __IO_STM32WL_LORA_CONFIG_H
#define __IO_STM32WL_LORA_CONFIG_H
...
/** Radio Driver Patching
  * ========================================================================<BR>
  * STM32WL needs to use proprietary data encoding methods as well as packet
