/* Copyright 2016 JP Norair
  ...
  */
/**
  * @file       /include/io/stm32wl_lora/subghz_defaults.h
  * @author     JP Norair
  * @version    R100
  * @date       27 Jan 2022
  * @brief      STM32WL LoRa register definitions and macros
  ...
  *
  * @note within the STM32WL documentation, the LoRa & RF interface is 
  *       referred-to as "subghz".
  ******************************************************************************
  */

#ifndef __subghz_defaults_H
#define __subghz_defaults_H
...
#ifdef __EVAL_RF__
#   include <io/stm32wl_lora/subghz_override.h>
#endif
